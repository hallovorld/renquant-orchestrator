...
# Source: hallovorld/renquant-orchestrator @ origin/pr-215-review
#   src/renquant_orchestrator/intraday_pairing_logger.py
#   commit 963a470c227b4ea8ad6c89b432f9ac02c7a9a1dc
# Do NOT edit by hand. When #215 merges to main, delete this fixture and the local
# round-trip test — `test_round_trip_into_intraday_pairing_logger` (importorskip)
# then exercises the real installed module. This "drops the actual consumer in" so
# the tick feed's interop is PROVEN now, not left branch-dependent/skipped.
