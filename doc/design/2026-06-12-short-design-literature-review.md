...
- **Momentum crashes:** Daniel & Moskowitz (2016, JFE) — the SHORT leg of
  ...
  exactly our E1 worst cases (INTU +18%, LMT +19% rips). **Design note (recorded for any future Phase-C design; E2/E3 are dropped in v5): rebound veto — no new shorts when SPY 60d return
