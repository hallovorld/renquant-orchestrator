...
This is the **same root cause** as the fund-freshness serving-axis clip bug
(PR #26 / #151): the rawlabel panel (`alpha158_291_fundamental_dataset_rawlabel.parquet`)
is frozen at 2026-02-11 and has not been rebuilt. Even with a working retrain
cadence (Candidate A fixed), promote will continue to refuse until rawlabel data
is refreshed.
