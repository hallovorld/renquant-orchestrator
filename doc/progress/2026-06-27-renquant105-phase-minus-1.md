> Recommitted 2026-07-03 from closed-unmerged PR #199 commit `dcd18b98` (S-REL V6 step 1,
> durability — archival, unchanged). Context + standing-verdict reading:
> `doc/progress/2026-07-03-v6-phase-minus-1-recommit.md`.
