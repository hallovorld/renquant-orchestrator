...
WHAT:     `scripts/validate_conviction_gate.py` — joins the accumulating decision ledger
          ...
          `demean_minus_raw_mean_fwd` + a DEMEAN_BETTER / NOT_BETTER verdict.
...
EVIDENCE: 2 unit tests (synthetic): INSUFFICIENT path + a DEMEAN_BETTER case where demean drops
          a realized loser. `[VERIFIED — pytest + live dry-run]`
